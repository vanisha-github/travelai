...
def create_planning_task(agent, trip_context: str, num_days: int = 5) -> Task:
    ...
    return Task(
        description=(
            ...
            "CRITICAL: Each day MUST have DIFFERENT activities, meals, and highlights. Do NOT repeat the same content across days.\n"
            "Day 1 should focus on arrival and orientation. Middle days on main attractions. Last day on departure/shopping.\n"
            "Assign SPECIFIC named places (restaurants, attractions, neighborhoods) to each time slot — NEVER use generic phrases like 'Visit top attractions'.\n\n"
